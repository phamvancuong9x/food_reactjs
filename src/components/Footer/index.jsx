  ...
  return (
    <footer>
      <div className="row">
          ...
          <div className="row">
            <div className="footer__contact col-sm-4 col-md-4">
              <div className="footer__contact-top">
                <div className="footer__logo">MOC FOOD</div>
                <div className="footer__phone-number">
                  <i className="fas fa-phone-alt"></i>
                  <a href="tel:0999996789">012345678</a>
                </div>
                <div className="footer__email">
                  <i className="fas fa-envelope"></i>
                  <a href="mailto:mocfood@gmail.com">mocfood@gmail.com</a>
                </div>
              </div>
            </div>
        ...
        <div className="footer__right col-md-12 col-lg-4">
          <h3 className="footer__title footer__social-title">
            THEO DÕI MOC FOOD TRÊN MẠNG XÃ HỘI
          </h3>
          ...
          <h3 className="footer__title footer__right-title">
            ĐĂNG KÝ NHẬN THÔNG TIN MỚI TỪ MOC FOOD
          </h3>
      ...
      <div className="footer_copyright">
        Copyrights &copy; 2021 by CuongPham
      </div>
    </footer>
  );
}
